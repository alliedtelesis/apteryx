 ...
 * @return true on successful registration
 */
bool apteryx_validate (const char *path, apteryx_validate_callback cb) __attribute__((nonnull (2)));
 ...
 * @return true on successful deregistration
 */
bool apteryx_unvalidate (const char *path, apteryx_validate_callback cb) __attribute__((nonnull (2)));
