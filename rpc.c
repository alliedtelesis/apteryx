        ...
        void *closure_data)
{
    ...
    rpc_socket_send_response (sock, msg->id, buffer.data, buffer.len);
    return;
}
        ...
        void *closure_data)
{
    ...
    /* Send the message */
    rpc_id id = rpc_socket_send_request (client->sock, tx_buffer.data, tx_buffer.len);
    PROTOBUF_C_BUFFER_SIMPLE_CLEAR (&tx_buffer);
