...
test_query_not_refreshed()
{
    ...
    /* Current behaviour is not smart - /cars will refresh /cars/suv/**/
    root = g_node_new (strdup("/"));
    apteryx_path_to_node (root, "/cars/sedan/*", NULL);
    apteryx_path_to_node (root, "/cars/hatchback/*", NULL);
...
static CU_TestInfo tests_api_tree[] = {
    ...
    { "query not refreshed", test_query_not_refreshed},
